...
<input placeholder="mm/dd/yyyy" id="mask1" name="fromdate" class="masked" type="text"  required>
</div>
<div class="input-field col m6 s12">
<label for="todate">To Date</label>
<input placeholder="mm/dd/yyyy" id="mask1" name="todate" class="masked" type="text"  required>
</div>
